...
public class MainActivity extends BaseActivity implements View.OnFocusChangeListener, ViewPager.OnPageChangeListener, RadioGroup.OnCheckedChangeListener {
